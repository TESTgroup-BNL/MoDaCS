# Source: https://github.com/sumit-1/ntpserver.git
# Modified 6/9/2022
...
class NTP_Server():
    ...
    def __init__(self, listenIp="0.0.0.0"):
        listenPort = 123
        self.sock = socket.socket(socket.AF_INET,socket.SOCK_DGRAM)
        self.sock.bind((listenIp,listenPort))
        print ("local socket: {}".format(self.sock.getsockname()))
        self.recvThread = RecvThread(self.sock)
        self.recvThread.start()
        self.workThread = WorkThread(self.sock)
