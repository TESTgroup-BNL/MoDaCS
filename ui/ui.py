...
# Form implementation generated from reading ui file 'D:/Users/amcmahon/OneDrive - Brookhaven National Laboratory/BNL/TEST/UAS/Software/MoDaCS/ui/qt/ui.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.plainTextEdit.setGeometry(QtCore.QRect(10, 140, 291, 71))
        ...
        self.btn_quit.setGeometry(QtCore.QRect(10, 90, 81, 41))
        ...
        self.btn_RemSD = QtWidgets.QPushButton(self.tab)
        self.btn_RemSD.setGeometry(QtCore.QRect(100, 90, 91, 41))
        self.btn_RemSD.setObjectName("btn_RemSD")
        self.lbl_mode = QtWidgets.QLabel(self.tab)
        self.lbl_mode.setGeometry(QtCore.QRect(200, 90, 63, 20))
        self.lbl_mode.setObjectName("lbl_mode")
        self.lbl_status = QtWidgets.QLabel(self.tab)
        self.lbl_status.setGeometry(QtCore.QRect(200, 110, 63, 20))
        self.lbl_status.setObjectName("lbl_status")
        self.tabWidget.addTab(self.tab, "")
        self.tab_3 = QtWidgets.QWidget()
        self.tab_3.setObjectName("tab_3")
        self.btn_ManTrig = QtWidgets.QPushButton(self.tab_3)
        self.btn_ManTrig.setGeometry(QtCore.QRect(80, 90, 81, 41))
        ...
        self.tbl_Instruments.setGeometry(QtCore.QRect(0, 30, 321, 81))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(51, 153, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Highlight, brush)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_RemSD.setText(_translate("MainWindow", "Remote SD"))
