...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setMinimumSize(QtCore.QSize(315, 291))
        ...
        self.widget.setMinimumSize(QtCore.QSize(290, 140))
        ...
        self.widget_log = QtWidgets.QWidget(self.widget)
        ...
        self.widget_log.setMinimumSize(QtCore.QSize(291, 121))
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Instrument Log:"))
