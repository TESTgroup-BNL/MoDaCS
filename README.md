...
An emulator for the Raspberry Pi’s GPIO ports.  Works with both inputs and outputs, interrupts are not supported, however.
...
**Run Configuration (core/run_cfg.ini)**
...
**Instrument Configuration (instruments/<instrument>/inst_cfg.ini)**
